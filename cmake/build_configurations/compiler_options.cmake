...
IF(UNIX)  
  ...
  IF(CMAKE_COMPILER_IS_GNUCC)
	  SET(COMMON_C_FLAGS               "-g -fabi-version=2 -fno-omit-frame-pointer -fno-strict-aliasing -Wno-implicit-fallthrough")
    ...
    SET(CMAKE_C_FLAGS_RELWITHDEBINFO "-O0 ${COMMON_C_FLAGS}")
  ENDIF()
  IF(CMAKE_COMPILER_IS_GNUCXX)
	  SET(COMMON_CXX_FLAGS               "-g -fabi-version=2 -fno-omit-frame-pointer -fno-strict-aliasing -Wno-implicit-fallthrough")
    ...
    SET(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-O0 ${COMMON_CXX_FLAGS}")
  ENDIF()
  ...
  IF(CMAKE_SYSTEM_NAME MATCHES "SunOS")
    ...
    IF(CMAKE_C_COMPILER_ID MATCHES "SunPro")
      ...
      SET(CMAKE_C_FLAGS_DEBUG       "${COMMON_C_FLAGS}")
      SET(CMAKE_CXX_FLAGS_DEBUG     "${COMMON_CXX_FLAGS}")
      SET(CMAKE_C_FLAGS_RELWITHDEBINFO   "-xO0 ${COMMON_C_FLAGS}")
      SET(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-xO0 ${COMMON_CXX_FLAGS}")
    ENDIF()
  ENDIF()
ENDIF()
