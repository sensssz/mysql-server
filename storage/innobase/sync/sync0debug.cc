...
LatchDebug::LatchDebug()
{
	...
	LEVEL_MAP_INSERT(SYNC_LOCK_SYS1);
	LEVEL_MAP_INSERT(SYNC_LOCK_SYS2);
	LEVEL_MAP_INSERT(SYNC_LOCK_SYS3);
	LEVEL_MAP_INSERT(SYNC_LOCK_SYS4);
	LEVEL_MAP_INSERT(SYNC_LOCK_SYS5);
	LEVEL_MAP_INSERT(SYNC_LOCK_SYS6);
	LEVEL_MAP_INSERT(SYNC_LOCK_SYS7);
	LEVEL_MAP_INSERT(SYNC_LOCK_SYS8);
	LEVEL_MAP_INSERT(SYNC_LOCK_SYS9);
	LEVEL_MAP_INSERT(SYNC_LOCK_SYS10);
	LEVEL_MAP_INSERT(SYNC_LOCK_SYS11);
	...
	UNIV_NOTHROW
{
	...
	case SYNC_LOCK_SYS8:
	case SYNC_LOCK_SYS9:
	case SYNC_LOCK_SYS10:
	case SYNC_LOCK_SYS11:
	...
	UNIV_NOTHROW
{
	...
	LATCH_ADD_MUTEX(LOCK_SYS1, SYNC_LOCK_SYS1, lock_mutex1_key);

	LATCH_ADD_MUTEX(LOCK_SYS2, SYNC_LOCK_SYS2, lock_mutex2_key);

	LATCH_ADD_MUTEX(LOCK_SYS3, SYNC_LOCK_SYS3, lock_mutex3_key);

	LATCH_ADD_MUTEX(LOCK_SYS4, SYNC_LOCK_SYS4, lock_mutex4_key);

	LATCH_ADD_MUTEX(LOCK_SYS5, SYNC_LOCK_SYS5, lock_mutex5_key);

	LATCH_ADD_MUTEX(LOCK_SYS6, SYNC_LOCK_SYS6, lock_mutex6_key);

	LATCH_ADD_MUTEX(LOCK_SYS7, SYNC_LOCK_SYS7, lock_mutex7_key);

	LATCH_ADD_MUTEX(LOCK_SYS8, SYNC_LOCK_SYS8, lock_mutex8_key);

	LATCH_ADD_MUTEX(LOCK_SYS9, SYNC_LOCK_SYS9, lock_mutex9_key);

	LATCH_ADD_MUTEX(LOCK_SYS10, SYNC_LOCK_SYS10, lock_mutex10_key);

	LATCH_ADD_MUTEX(LOCK_SYS11, SYNC_LOCK_SYS11, lock_mutex11_key);
