...
mysql_pfs_key_t lock_rw_key;
mysql_pfs_key_t	lock_mutex_key;
mysql_pfs_key_t	lock_mutex1_key;
mysql_pfs_key_t	lock_mutex2_key;
mysql_pfs_key_t	lock_mutex3_key;
mysql_pfs_key_t	lock_mutex4_key;
mysql_pfs_key_t	lock_mutex5_key;
mysql_pfs_key_t	lock_mutex6_key;
mysql_pfs_key_t	lock_mutex7_key;
mysql_pfs_key_t	lock_mutex8_key;
mysql_pfs_key_t	lock_mutex9_key;
mysql_pfs_key_t	lock_mutex10_key;
mysql_pfs_key_t	lock_mutex11_key;
