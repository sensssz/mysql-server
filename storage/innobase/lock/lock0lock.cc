...
void lock_mutex_enter1() {
	mutex_enter(&lock_sys->mutex1);
}

/** Release the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_exit1() {
	lock_sys->mutex1.exit();
}

/** Acquire the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_enter2() {
	mutex_enter(&lock_sys->mutex2);
}

/** Release the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_exit2() {
	lock_sys->mutex2.exit();
}

/** Acquire the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_enter3() {
	mutex_enter(&lock_sys->mutex3);
}

/** Release the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_exit3() {
	lock_sys->mutex3.exit();
}

/** Acquire the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_enter4() {
	mutex_enter(&lock_sys->mutex4);
}

/** Release the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_exit4() {
	lock_sys->mutex4.exit();
}

/** Acquire the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_enter5() {
	mutex_enter(&lock_sys->mutex5);
}

/** Release the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_exit5() {
	lock_sys->mutex5.exit();
}

/** Acquire the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_enter6() {
	mutex_enter(&lock_sys->mutex6);
}

/** Release the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_exit6() {
	lock_sys->mutex6.exit();
}

/** Acquire the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_enter7() {
	mutex_enter(&lock_sys->mutex7);
}

/** Release the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_exit7() {
	lock_sys->mutex7.exit();
}

/** Acquire the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_enter8() {
	mutex_enter(&lock_sys->mutex8);
}

/** Release the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_exit8() {
	lock_sys->mutex8.exit();
}

/** Acquire the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_enter9() {
	mutex_enter(&lock_sys->mutex9);
}

/** Release the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_exit9() {
	lock_sys->mutex9.exit();
}

/** Acquire the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_enter10() {
	mutex_enter(&lock_sys->mutex10);
}

/** Release the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_exit10() {
	lock_sys->mutex10.exit();
}

/** Acquire the lock_sys->mutex. */
__attribute__((noinline))
void lock_mutex_enter11() {
	mutex_enter(&lock_sys->mutex11);
}
	...
	ulint	n_cells)	/*!< in: number of slots in lock hash table */
{
	...
	mutex_create(LATCH_ID_LOCK_SYS, &lock_sys->mutex3);

	mutex_create(LATCH_ID_LOCK_SYS, &lock_sys->mutex4);

	mutex_create(LATCH_ID_LOCK_SYS, &lock_sys->mutex5);

	mutex_create(LATCH_ID_LOCK_SYS, &lock_sys->mutex6);

	mutex_create(LATCH_ID_LOCK_SYS, &lock_sys->mutex7);

	mutex_create(LATCH_ID_LOCK_SYS, &lock_sys->mutex8);

	mutex_create(LATCH_ID_LOCK_SYS, &lock_sys->mutex9);

	mutex_create(LATCH_ID_LOCK_SYS, &lock_sys->mutex10);
...
/*================*/
{
	...
	mutex_destroy(&lock_sys->mutex1);

	mutex_destroy(&lock_sys->mutex2);

	mutex_destroy(&lock_sys->mutex3);

	mutex_destroy(&lock_sys->mutex4);

	mutex_destroy(&lock_sys->mutex5);

	mutex_destroy(&lock_sys->mutex6);

	mutex_destroy(&lock_sys->mutex7);

	mutex_destroy(&lock_sys->mutex8);

	mutex_destroy(&lock_sys->mutex9);

	mutex_destroy(&lock_sys->mutex10);

	mutex_destroy(&lock_sys->mutex11);
